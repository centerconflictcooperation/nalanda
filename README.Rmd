...
This example uses the bundled `toy_sim_results` dataset so it renders quickly and does not require running live AI simulations.
...
Use the raw chapter-level results directly with the time-series plotting helper:
