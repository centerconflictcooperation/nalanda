...
This outlines how to propose a change to nalanda. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("centerconflictcooperation/nalanda", fork = TRUE)`.
...
Please note that the nalanda project is released with a [Contributor
Code of
Conduct](https://centerconflictcooperation.github.io/nalanda/CODE_OF_CONDUCT.md).
